...
<body>
    ...
    <div class="container shadow-none mt-0">
        <div class="row text-center justify-content-center my-4">
            <div class="col-md-6 wrapper shadow p-3 pt-2" >
    ...
    $(document).ready(function () {
        $('#cbx_horario').change(function () {
            $("#cbx_horario option:selected").each(function () {
                id_taller = $('#cbx_taller').val();
                id_sede = $('#cbx_sede').val();
                dia = $('#cbx_dia').val(); 
                horario = $('#cbx_horario').val(); 
                $.post("assets/include/getTeacher.php", { id_taller: id_taller,  id_sede: id_sede, dia: dia, horario: horario}
                ,   function(data) {
